...
class MNIST(nn.Module):
    def __init__(self, in_channels, hidden_channels_1, hidden_channels_2, num_classes):
        ...
        self.features = nn.Sequential(
             ...
             nn.ReLU(),
             nn.MaxPool2d(2),
             nn.Conv2d(hidden_channels_1, hidden_channels_1, kernel_size=3, padding=1, groups = hidden_channels_1),
             nn.Conv2d(hidden_channels_1, hidden_channels_2, kernel_size=1,),
        ...
        self.classifier = nn.Sequential(
            nn.Flatten(),
            nn.Linear(hidden_channels_2*7*7, num_classes)
        )
